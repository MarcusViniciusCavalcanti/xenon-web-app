...
public class FeatureRegistryNewStudentsTest extends AbstractEndToEndTest {
    ...
    @Test
    @DisplayName("Deve exibir mensagem com alert de erro de token")
    void shouldShowErrorToken() {
